<template>
    <form action="" class="register" @submit.prevent="onSubmit">
        ...
        <fieldset>
            <FormInput :error="errors.username" name="username" v-model="username" label="Потребителско име" required />

            <FormInput :error="errors.name" name="name" v-model="name" label="Име" required />

            <FormInput :error="errors.tel" name="tel" v-model="tel" label="Телефон" required />
